...
class FAT_Plugin {
    ...
    protected $runner_context_service;
    ...
    protected function __construct() {
        ...
        $this->runner_context_service = new FAT_Runner_Context_Service();
        $this->tool_runner     = new FAT_Tool_Runner( $this->tools_repo, $this->runs_repo, $this->settings, $this->prompt_engine, $this->client, $this->usage_limiter, $this->featured_image_generator, $this->uploaded_image_processor, $this->attachment_metadata_assistant, $this->runner_context_service );
